...
function NavBarMobile() {
  ...
  return (
    <>
      ...
      {navMenuActive ? <AiIcons.AiOutlineClose className="menu-bars bars" onClick={CallNavMenu} /> : <AiIcons.AiOutlineMenu className="menu-bars close" onClick={CallNavMenu} />}

      <div className={!navMenuActive ? 'nav-modal' : 'nav-modal active'} onClick={CallNavMenu} ></div>

      <nav id="navbar" className={!navMenuActive ? 'navbar' : 'navbar active'}>
          <ul>
            <li><Link target="_blank" to="google.com">Premium</Link></li>
            <li><Link target="_blank" to="google.com">Suporte</Link></li>
            <li><Link target="_blank" to="google.com">Baixar</Link></li>   
            <li role="separator" className="nav-separator"></li>
            <li><Link to="/signup">Inscrever-se</Link></li>
