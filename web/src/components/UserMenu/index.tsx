...
const UserMenu:React.FC<UserMenuProps> = (props) => {
  ...
  const [playlists] = useState([
    ...
    {
      name: 'Eletrônicas 2020',
      id: 5
    },
    {
      name: 'É Bomdimais Jûnio',
      id: 6
    },    
    {
      name: 'Lofi Musics',
  ...
  return (
    <nav className="user-menu">
      ...
      <div className="playlistsMenu">
        <strong>Playlsits</strong>
        <div className="newPlaylist-block">
          <HiIcons.HiOutlinePlus className="createPlaylistIcon"/>
          <span>Criar playlist</span>
        </div>
        <div className="newPlaylist-block">
          <AiIcons.AiOutlineHeart  className="favoritesPlaylistIcon"/>
